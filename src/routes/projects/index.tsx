...
import chaka from "@/assets/projects/34.jpg";
...
const projects: Project[] = [
  { slug: "chaka-fuel-station", img: chaka, title: "Chaka Fuel Station", badge: "Ongoing", desc: "Full turnkey petroleum station build in Chaka — underground tanks, dispenser assembly and commissioning, currently in progress." },
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {projects.map((p) => (
          ...
          >
            ...
            {p.badge && (
              <span className="absolute left-3 top-3 inline-flex items-center gap-1.5 rounded-full bg-primary px-3 py-1 text-xs font-bold text-white shadow">
